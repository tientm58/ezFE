...
ezCloud.controller('CMReservationController', ['$rootScope', '$state', '$translate', '$scope', '$mdSidenav', '$log', '$timeout', 'loginFactory', 'dialogService', '$window', '$location', '$mdDialog', '$localStorage','$mdDialog','$mdMedia','CMFactory', '$route',
        function ($rootScope, $state, $translate, $scope, $mdSidenav, $log, $timeout, loginFactory, dialogService, $window, $location, $mdDialog, $localStorage,$mdDialog,$mdMedia,CMFactory,$route) {
    ...
    function Init(){
        ...
        $scope.searchResult = [];
        CMFactory.processCMSearchReservation($scope.search, function (data) {
