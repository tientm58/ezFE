ezCloud.controller('receiptdetailsController', ['$scope', '$rootScope', '$state', '$location', '$mdDialog', '$mdMedia', '$timeout', '$filter', 'loginFactory', 'utilsFactory', '$localStorage', 'dialogService', 'exportBuilder',
	...
	$scope.action = {
		getReportData: function(startDate, endDate, paymenttypedetailid, type)
		{
			...
			console.log(startDate2, endDate2,"leo nguyen33333");
			var params = 
			{
		...
		export:
		{
			...
			{
				var exportHref = exportBuilder.tableToExcel(gridId, 'Báo cáo chi tiết thu ' + $scope.attributes.reportname);
