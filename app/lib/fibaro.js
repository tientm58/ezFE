...
var fibaroProcess;
var fibaroCallback;
var fibaroReady = false;
$(function () {
    function fibaroLoader() {
        var loader = new ScriptLoader();
        loader.require('http://localhost:50005/signalr/hubs', {
            async: true, success: function () {

                fibaroReady = true;
                $.connection.hub.url = "http://localhost:50005/signalr";
                fibaroProcess = $.connection.myHub;
                fibaroProcess.client.sendUpdate = function(devices){
                    //console.log(devices);
                    if (fibaroCallback && typeof fibaroCallback === "function") fibaroCallback(devices);
                };
